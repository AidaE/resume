...
export const AuthWrapper: React.FC<AuthWrapperProps> = ({ children }) => {
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <form onSubmit={handleAuth} className="space-y-6">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:bg-blue-400 transition-colors font-medium"
              >
                {authLoading ? (
  ...
  return (
    <div>
      {children}
      {/* Sign out button in header will be added to main app */}
    </div>
  );
};